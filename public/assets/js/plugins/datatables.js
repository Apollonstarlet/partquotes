				...
				function (t, e, s) {
									...
									(i = e.cloneNode(!1)),
										...
										t.forEach((t) => {
											(h = e.cells[t].cloneNode(!0)),
												...
												i.appendChild(h),
												l.hiddenColumns.includes(t) || ((h = e.cells[t].cloneNode(!0)), (h.data = e.cells[t].data), a.appendChild(h));
										}),
										o[2].push(i),
										o[3].push(a);
								}),
						...
						sort(e, s, i) {
							...
							Promise.all(p).then((t) => {
								...
								Array.from(r).forEach((t) => {
									...
									'desc' == s
										? ((p = h(o, -1)), (f = h(l, -1)), u.classList.remove('asc'), u.classList.add('desc'))
										: ((p = h(l, 1)), (f = h(o, 1)), u.classList.remove('desc'), u.classList.add('asc')),
					...
					class u {
						...
						bindEvents() {
							...
							t.searchable &&
								((this.input = this.wrapper.querySelector('.dataTable-input')), this.input && this.input.addEventListener('keyup', () => this.search(this.input.value), !1)),
								...
								if (((this.columnWidths = []), this.table.tHead)) {
									if (
										(this.options.scrollY.length &&
											((e = a('thead')), e.appendChild(a('tr')), (e.style.height = '0px'), this.headerTable && (this.table.tHead = this.headerTable.tHead)),
										...
										this.table.replaceChild(e, s),
											...
											(this.headerTable.parentElement.style.paddingRight =
												this.headerTable.clientWidth - this.table.clientWidth + parseInt(this.headerTable.parentElement.style.paddingRight || '0', 10) + 'px'),
