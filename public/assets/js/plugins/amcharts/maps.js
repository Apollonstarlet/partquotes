		...
		QJ7E: function (t, e, n) {
			...
			var At = {
				...
				polygonEnd: function () {
					dt.polygonEnd(),
						...
						(At.lineStart = Ft),
						(At.lineEnd = Bt),
						pt < 0 ? ((bt = -(St = 180)), (Pt = -(_t = 90))) : Ot > E ? (_t = 90) : Ot < -E && (Pt = -90),
						(Ct[0] = bt),
						(Ct[1] = St);
				},
				sphere: function () {
			...
			function Rt(t, e) {
				...
				if (wt) {
					...
					c ^ (u * Mt < s && s < u * t)
						? (o = r[1] * z) > _t && (_t = o)
						: c ^ (u * Mt < (s = ((s + 360) % 360) - 180) && s < u * t)
						? (o = -r[1] * z) < Pt && (Pt = o)
						: (e < Pt && (Pt = e), e > _t && (_t = e)),
						c
							? t < Mt
								? qt(bt, t) > qt(bt, St) && (St = t)
								: qt(t, St) > qt(bt, St) && (bt = t)
							: St >= bt
							? (t < bt && (bt = t), t > St && (St = t))
							: t > Mt
							? qt(bt, t) > qt(bt, St) && (St = t)
						...
						var o,
							...
							p = {
								...
								polygonEnd: function () {
									...
									var t = Fe(o, i);
									a.length ? (h || (r.polygonStart(), (h = !0)), Ae(a, We, t, n, r)) : t && (h || (r.polygonStart(), (h = !0)), r.lineStart(), n(null, null, 1, r), r.lineEnd()),
										h && (r.polygonEnd(), (h = !1)),
										(a = o = null);
								},
								sphere: function () {
					...
					return {
						...
						point: function (o, a) {
							var u = o > 0 ? T : -T,
								s = A(o - n);
							A(s - T) < E
								? (t.point(n, (i = (i + a) / 2 > 0 ? D : -D)), t.point(r, i), t.lineEnd(), t.lineStart(), t.point(u, i), t.point(o, i), (e = 0))
								: r !== u &&
								  s >= T &&
								  (A(n - r) < E && (n -= r * E),
								  A(o - u) < E && (o -= u * E),
			...
			var qe = function (t) {
					...
					function a(t, n, i) {
						...
						if (!(v < 0)) {
							...
							if (
								(!j && M < _ && ((b = _), (_ = M), (M = b)),
								j || x < E ? (j ? (_ + M > 0) ^ (y[1] < (A(y[0] - P) < E ? _ : M)) : _ <= y[1] && y[1] <= M) : (x > T) ^ (P <= y[0] && y[0] <= S))
							) {
								var w = zt(f, (-d + m) / g);
						...
						function (t) {
							...
							return {
								...
								point: function (h, p) {
									...
									if ((!e && (c = s = g) && t.lineStart(), g !== s && (!(f = a(e, d)) || ze(e, f) || ze(d, f)) && (d[2] = 1), g !== s))
										(l = 0), g ? (t.lineStart(), (f = a(d, e)), t.point(f[0], f[1])) : ((f = a(e, d)), t.point(f[0], f[1], 2), t.lineEnd()), (e = f);
									else if (r && e && i ^ g) {
										var m;
										v & n ||
											!(m = a(d, e, !0)) ||
			...
			function _n() {
				...
				return (
					...
					(m.extentMajor = function (t) {
						return arguments.length
							? ((i = +t[0][0]), (n = +t[1][0]), (u = +t[0][1]), (a = +t[1][1]), i > n && ((t = i), (i = n), (n = t)), u > a && ((t = u), (u = a), (a = t)), m.precision(v))
							: [
									[i, u],
									[n, a]
							  ];
					...
					(m.extentMinor = function (n) {
						return arguments.length
							? ((e = +n[0][0]), (t = +n[1][0]), (o = +n[0][1]), (r = +n[1][1]), e > t && ((n = e), (e = t), (t = n)), o > r && ((n = o), (o = r), (r = n)), m.precision(v))
							: [
									[e, o],
									[t, r]
							  ];
								...
								function n(i, r, o, a, u, s, c, l, h, p, f, d, g, v) {
									...
									if (b > 4 * e && g--) {
										var P = a + p,
											...
											I = L - r,
											T = y * C - m * I;
										((T * T) / b > e || A((m * C + y * I) / b - 0.5) > 0.3 || a * p + u * f + s * d < zi) &&
											(n(i, r, o, a, u, s, O, L, j, (P /= M), (S /= M), _, g, v), v.point(O, L), n(O, L, j, P, S, _, c, l, h, p, f, d, g, v));
									}
								}
								return function (e) {
									var i,
			...
			function Fi(t) {
				...
				return (
					...
					(O.clipExtent = function (t) {
						return arguments.length
							? ((j = null == t ? ((x = i = r = o = null), Cn) : Je((x = +t[0][0]), (i = +t[0][1]), (r = +t[1][0]), (o = +t[1][1]))), E())
							: null == x
							? null
							: [
									[x, i],
			...
			var Wi = function () {
				...
				Zi = function () {
					return Wi().parallels([29.5, 45.5]).scale(1070).translate([480, 250]).rotate([96, 0]).center([-0.6, 38.7]);
				};
			var qi = function () {
				var t,
					e,
				...
				return (
					(l.invert = function (t) {
						var e = a.scale(),
							...
							i = (t[0] - n[0]) / e,
							r = (t[1] - n[1]) / e;
						return (r >= 0.12 && r < 0.234 && i >= -0.425 && i < -0.214 ? u : r >= 0.166 && r < 0.234 && i >= -0.214 && i < -0.115 ? s : a).invert(t);
					}),
					(l.stream = function (n) {
						return t && e === n
							? t
					...
					(l.scale = function (t) {
						return arguments.length ? (a.scale(t), u.scale(0.35 * t), s.scale(t), l.translate(a.translate())) : a.scale();
					}),
			...
			function er(t) {
				...
				return (
					...
					(r.clipExtent = function (t) {
						return arguments.length
							? (null == t ? (c = e = n = i = null) : ((c = +t[0][0]), (e = +t[0][1]), (n = +t[1][0]), (i = +t[1][1])), l())
							: null == c
							? null
							: [
									[c, e],
			...
			dr.invert = function (t, e) {
				for (
					...
					a < 12 && ((o = (r = (i -= n = (i * (cr + lr * r + o * (hr + pr * r)) - e) / (cr + 3 * lr * r + o * (7 * hr + 9 * pr * r))) * i) * r * r), !(A(n) < I));
					++a
				);
				...
				yr = function () {
					...
					return (
						...
						(b.clipExtent = function (t) {
							return arguments.length
								? ((m = null == t ? ((f = n = i = r = null), Cn) : Je((f = +t[0][0]), (n = +t[0][1]), (i = +t[1][0]), (r = +t[1][1]))), y())
								: null == f
								? null
								: [
										[f, n],
			...
			br.invert = function (t, e) {
				...
				do {
					var o = i * i,
						a = o * o;
					i -= n =
						(i * (1.007226 + o * (0.015085 + a * (0.028874 * o - 0.044475 - 0.005916 * a))) - e) / (1.007226 + o * (0.045255 + a * (0.259866 * o - 0.311325 - 0.005916 * 11 * a)));
				} while (A(n) > E && --r > 0);
						...
						(e.prototype.updateExtremes = function () {
							...
							this.dataItems.each(function (r) {
								...
								(this.north == t && this.east == n && this.south == e && this.west == i) ||
									((this._north = t), (this._east = n), (this._west = i), (this._south = e), this.dispatch('geoBoundsChanged'), this.ignoreBounds || this.chart.updateExtremes());
						}),
						Object.defineProperty(e.prototype, 'north', {
							get: function () {
			...
			var qr = (function (t) {
				function e() {
					var e = t.call(this) || this;
					(e.className = 'MapPolygon'), (e.polygon = e.createChild(Tr.a)), (e.polygon.shouldClone = !1), (e.polygon.applyOnClones = !0), e.setPropertyValue('precision', 0.5);
					var n = new p.a();
					return (
								...
								if ((this.geodata && (e = this.geodata), e)) {
									...
									if (
										('FeatureCollection' == e.type
											...
											: 'Feature' == e.type
											? (n = [e])
											: -1 != ['Point', 'LineString', 'Polygon', 'MultiPoint', 'MultiLineString', 'MultiPolygon'].indexOf(e.type)
											? (n = [
													{
														geometry: e
													}
			...
			var Qr = (function () {
				...
				return (
					Object.defineProperty(t.prototype, 'd3Projection', {
						...
						set: function (t) {
							(this._d3Projection = t), t.precision(0.1), (this._d3Path = wi().projection(t)), this.chart && this.chart.invalidateProjection();
						},
						enumerable: !0,
						configurable: !0
					}),
				...
				no = (function (t) {
					...
					return (
						...
						Object.defineProperty(e.prototype, 'chart', {
							...
							set: function (t) {
								this.chart != t &&
									this._chart.set(t, new h.c([t.events.on('mappositionchanged', this.updateRectangle, this, !1), t.events.on('scaleratiochanged', this.updateMapSize, this, !1)]));
							},
							enumerable: !0,
							configurable: !0
						}),
							...
							if ((this.data.length > 0 && 0 == this._parseDataFrom && this.mapImages.clear(), this.useGeodata && (this.useGeodata || this.geodata))) {
								...
								if (
									('FeatureCollection' == n.type
										...
										: 'Feature' == n.type
										? (i = [n])
										: -1 != ['Point', 'LineString', 'Polygon', 'MultiPoint', 'MultiLineString', 'MultiPolygon'].indexOf(n.type)
										? (i = [
												{
													geometry: n
												}
					...
					return (
						...
						Object.defineProperty(e.prototype, 'lineObjects', {
							get: function () {
								return (
									this._lineObjects ||
										((this._lineObjects = new Xr.e(new co())),
						...
						Object.defineProperty(e.prototype, 'arrow', {
							get: function () {
								if (!this._arrow) {
									...
									(e.fillOpacity = 1),
										(e.width = Object(go.c)(100)),
										(e.height = Object(go.c)(100)),
										(e.rotation = 90),
					...
					return (
						...
						(e.prototype.handlePanDown = function (t) {
							...
							e.x > 0 &&
								...
								((this._downPointOrig = Yr.documentPointToSprite(t.pointer.point, this.seriesContainer)),
							...
							if (!this.seriesContainer.isResized) {
								...
								if ('move' != e && 'none' != e && this._downPointOrig && t.rotate) {
									...
									u && (s = this.projection.invert(u)),
										t.rotate([i, r, o]),
										s &&
											(('rotateLat' != e && 'rotateLongLat' != e) || (this.deltaLatitude = this._downDeltaLatitude + s.latitude - a.latitude),
						...
						Object.defineProperty(e.prototype, 'mouseWheelBehavior', {
							...
							set: function (t) {
								this.setPropertyValue('mouseWheelBehavior', t) &&
									('none' != t
										? ((this._mouseWheelDisposer = this.chartContainer.events.on('wheel', this.handleWheel, this, !1)), this._disposers.push(this._mouseWheelDisposer))
										: (this._mouseWheelDisposer && this._mouseWheelDisposer.dispose(), (this.chartContainer.wheelable = !1)));
							},
							enumerable: !0,
							configurable: !0
						}),
								...
								if (u) {
									...
									return (
										!r &&
											...
											e < 1.5 &&
											((l = this.innerWidth / 2 - (this.seriesMaxLeft + (this.seriesMaxRight - this.seriesMaxLeft) / 2) * e * this.scaleRatio),
						...
						(e.prototype.rotateMap = function () {
							this.projection.d3Projection &&
								...
								(this.projection.d3Projection.rotate([this.deltaLongitude, this.deltaLatitude, this.deltaGamma]), this.invalidateProjection(), this.updateExtremes());
						}),
			...
			var jo = n('xgTw'),
				wo = (function (t) {
					...
					return (
						Object(c.c)(e, t),
						(e.prototype.createLine = function () {
							(this.line = new jo.a()), (this.line.tensionX = 0.8), (this.line.tensionY = 0.8);
						}),
						Object.defineProperty(e.prototype, 'shortestDistance', {
							get: function () {
								return !1;
							...
							(t.x = void 0),
								...
								'vertical' == this.layout
									? ((this.width = 40),
									  ...
									  (e.width = Object(go.c)(100)),
									  (e.height = void 0),
									  (n.width = Object(go.c)(100)),
									  (n.height = void 0),
									  (t.width = Object(go.c)(100)),
									  (t.height = void 0),
									  (i.width = Object(go.c)(100)),
									  (e.marginTop = 1),
									  (t.marginBottom = 2),
									  (i.height = 0),
									  e.toFront(),
									...
									: 'horizontal' == this.layout &&
									  ...
									  (e.height = Object(go.c)(100)),
									  (e.width = void 0),
									  (t.height = Object(go.c)(100)),
									  (t.width = void 0),
									  (n.height = Object(go.c)(100)),
									  (n.width = void 0),
									  (n.minX = 0),
									  (n.minY = 0),
									  (n.maxY = 0),
									  (i.height = Object(go.c)(100)),
									  (i.width = 0),
									  e.toBack(),
									  t.toFront());
						}),
			...
			fa.invert = function (t, e) {
				...
				var n = 1 + t * t + e * e,
					...
					u = ha(o),
					s = u * u - a * a;
				return [2 * Xo(t) * ko(la(o) * a, 0.25 - s), 2 * Xo(e) * ko(u * Yo(r), 0.25 + s)];
			};
			var da = ca(8),
				ga = Ho(1 + na);
			...
			Ba(2.8284, -1.6988, 0.75432, -0.18071, 1.76003, -0.38914, 0.042555),
				Ba(2.583819, -0.835827, 0.170354, -0.038094, 1.543313, -0.411435, 0.082742),
				Ba((5 / 6) * Qo, -0.62636, -0.0344, 0, 1.3493, -0.05524, 0, 0.045);
			...
			Ba(2.6516, -0.76534, 0.19123, -0.047094, 1.36289, -0.13965, 0.031762);
			...
			function Wa(t, e) {
				...
				var s = (function (t, e) {
					...
					var m,
						...
						j = (4 * t) / Qo;
					if (t > 0.222 * Qo || (e < Qo / 4 && t > 0.175 * Qo)) {
			...
			Wa.invert = function (t, e) {
				...
				var n = Xo(t),
					...
					u = (function (t, e) {
						...
						return [(Qo / 4) * (t * (-2 * b * (((0.5 * S) / h) * (1 - a) - 2 * r * h * P) + -b * P * g) + -b * (r * (1 + a) * S + l * (1 + 3 * a) * P) * ua(t / ca(p))), m];
					})(a ? o : r, a ? r : o),
					s = u[0],
					c = u[1],
					l = Ro(c);
				...
				var n = (na - 1) / (na + 1),
					...
					u = (function (t, e) {
						var n = t * t,
							i = e + 1,
							r = 1 - n - e * e;
						return [0.5 * ((t >= 0 ? $o : -$o) - ko(r, 2 * t)), -0.25 * Ho(r * r + 4 * n) + 0.5 * Ho(i * i + n)];
					})(a * Ro(-1 * t), a * Yo(-1 * t)),
					s = (function (t, e, n) {
						var i = Vo(t),
							r = la(Vo(e));
				...
				var n = (na - 1) / (na + 1),
					...
					r = (function (t, e, n) {
						...
						return t
							? ((i = Za(t, n)),
							  e
									? ((o = (r = Za(e, 1 - n))[1] * r[1] + n * i[0] * i[0] * r[0] * r[0]),
									  [
					...
					})(0.5 * qa($o, i * i) - e, -t, i * i),
					o = (function (t, e) {
						var n = e[0] * e[0] + e[1] * e[1];
						return [(t[0] * e[0] + t[1] * e[1]) / n, (t[1] * e[0] - t[0] * e[1]) / n];
					})(r[0], r[1]);
				return [ko(o[1], o[0]) / -1, 2 * Ao(Fo(-0.5 * Ho(n * o[0] * o[0] + n * o[1] * o[1]))) - $o];
			};
			ua(1 - 1 / 3), Ca(0);
			var Ya = 0.7109889596207567,
				Ua = 0.0528035274542;
			...
			function iu(t, e) {
				return [t, 1.25 * Ho(Uo(ta + 0.4 * e))];
			}
			iu.invert = function (t, e) {
				return [t, 2.5 * Ao(Fo(0.8 * e)) - 0.625 * Qo];
			};
			var ru = function () {
			...
			function su(t, e) {
				for (var n, i = (1 + ea) * Yo(e), r = e, o = 0; o < 25 && ((r -= n = (Yo(r / 2) + Yo(r) - i) / (0.5 * Ro(r / 2) + Ro(r))), !(Vo(n) < Jo)); o++);
			...
			function cu(t, e) {
				for (var n, i = ca(6 / (4 + Qo)), r = (1 + Qo / 4) * Yo(e), o = e / 2, a = 0; a < 25 && ((o -= n = (o / 2 + Yo(o) - r) / (0.5 + Ro(o))), !(Vo(n) < Jo)); a++);
				return [(i * (0.5 + Ro(o)) * t) / 1.5, i * o];
			}
			cu.invert = function (t, e) {
				var n = ca(6 / (4 + Qo)),
					i = e / n;
				return Vo(Vo(i) - $o) < Jo && (i = i < 0 ? -$o : $o), [(1.5 * t) / (n * (0.5 + Ro(i))), ua((i / 2 + Yo(i)) / (1 + Qo / 4))];
			};
			...
			function lu(t, e) {
				var n = e * e,
					i = n * n,
					r = n * i;
				return [t * (0.84719 - 0.13063 * n + r * r * (0.05494 * n - 0.04515 - 0.02326 * i + 0.00331 * r)), e * (1.01183 + i * i * (0.01926 * n - 0.02625 - 0.00396 * i))];
			}
			lu.invert = function (t, e) {
				var n,
					...
					u = 25;
				do {
					a -= n = (a * (1.01183 + (r = (i = a * a) * i) * r * (0.01926 * i - 0.02625 - 0.00396 * r)) - e) / (1.01183 + r * r * (0.21186 * i - 0.23625 + -0.05148 * r));
				} while (Vo(n) > Ko && --u > 0);
				return [t / (0.84719 - 0.13063 * (i = a * a) + (o = i * (r = i * i)) * o * (0.05494 * i - 0.04515 - 0.02326 * r + 0.00331 * o)), a];
			};
					...
					do {
						...
						if (f >= 0 || 1 === o) {
							...
							var d,
								g = 50;
							do {
								(f = (r = Zo(18, Vo(i) / 5)) - (o = Bo(r))),
									(a = wu[o][1]),
									(u = wu[o + 1][1]),
									(s = wu[Zo(19, o + 2)][1]),
									(i -= (d = (e >= 0 ? $o : -$o) * (u + (f * (s - a)) / 2 + (f * f * (s - 2 * u + a)) / 2) - e) * oa);
							} while (Vo(d) > Ko && --g > 0);
							break;
						}
					} while (--o >= 0);
			...
			Lu.invert = function (t, e) {
				var n = e / 1.70711,
					i = Yo(ta * n);
				return [t / (0.74482 - 0.34588 * i * i), 2 * Ao(n)];
			};
		...
		'o+vr': function (t, e, n) {
			...
			function r(t, e, n) {
				...
				for (var _ = m.length; m.length; ) {
					var M = m.pop();
					M.d > P.d && ((P = M), n && console.log('found best %d after %d probes', Math.round(1e4 * M.d) / 1e4, _)),
						M.max - P.d <= e ||
							((g = M.h / 2),
