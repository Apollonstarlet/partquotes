<aside data-color="info"
    ...
    <div class="collapse navbar-collapse w-auto bg-gray-200" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link {{ (Request::is('quote-automate') ? 'active' : '') }}"
                    href="{{ url('quote-automate') }}">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i style="font-size: 1rem;"
                            class="fas fa-lg fa-cloud-upload ps-2 pe-2 text-center text-dark {{ (Request::is('quote-automate') ? 'text-white' : 'text-dark') }} "
                            aria-hidden="true"></i>
                    </div>
                    <span class="nav-link-text ms-1">Quote Automate</span>
                </a>
            </li>
